...
data "aws_iam_policy_document" "this" {
  ...
  # Every function has Active tracing enabled (see terraform/modules/lambda),
  # so every role needs this regardless of role_group. X-Ray's API has no
  # resource-level permissions -- "*" here matches AWS's own
