...
const ensureStateMachine = async (
  ...
  const definition = template
    ...
    .replaceAll('${dead_letter_queue_url}', resources.deadLetterQueueUrl);
...
export interface DeployedLambdaInfrastructure {
  stateMachineArn: string;
  resources: LocalstackResources;
}

export const deployLambdaInfrastructure =
  async (): Promise<DeployedLambdaInfrastructure> => {
    ...
    return { stateMachineArn, resources };
  };
